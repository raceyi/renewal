...
export class FaqPage {
  questions=[{hidden:true,
             ...
             {hidden:true,
               question:"캐시 충전 확인 메시지를 받지 못했어요.",answer:"지갑탭->내역보기->입급확인 대기중 항목을 클릭 하시면 충전 확인 메시지를 보실수 있습니다. 만약 5분이 지나도 확인 항목이 없다면 고객센터(0505-170-3636,help@takit.biz)에 연락부탁드립니다."},
             {hidden:true,
               question:"캐시 충전 확인 메시지에서 확인을 요청하지 않고 취소를 선택했어요.",answer:"지갑탭->입급확인 대기중 항목을 클릭 하시면 충전 확인 메시지를 다시 보실수 있습니다."},
             {hidden:true,
               question:"본인명의 휴대폰이 없어요.",answer:"보안을 위해 웨이티아이디 설정시 본인확인 과정을 거치고 있습니다. 본인명의 휴대폰이 없을 경우 사용이 불가능합니다."},
             {hidden:true,
             ...
             {hidden:true,
               question: "무료 결제수수료가 어떤 의미인가요?",answer:"고객님의 온라인 결제시 카드 결제 수수료는 3.2%, 은행자동인출은 450원,가상계좌는 300원의 수수료가 지불됩니다. 웨이티 캐시는 여러분의 웨이티아이디 입력을 통해 외부수수료 없이 운영 됩니다. 상점주는 결제 수수료 없이 웨이티 서비스 수수료 1%만을 지불하시면 됩니다."},
             ];
