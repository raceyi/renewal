...
export class StorageProvider{
    ...
    available = {sales:0,fee:0,originalPrice:0};  // 마지막 인출이후 주문의 합
    withdrawable={sales:0,fee:0, netSales:0,originalPrice:0, fromOrderId:0, toOrderId:0} // 마지막 인출이후 쌓인 매출 값중 환불이 불가능한 7일 이전의 주문합 
    ...
    // kioskNotify를 위한 변수들 
    public kioskNotify:boolean=false;
    public socketId;
    public myIPAddress;
    public port;
